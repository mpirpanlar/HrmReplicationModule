...
namespace Sentez.EgeHayatHrmReplicationModule.Parameters
{
    public class EgeHayatHrmReplicationModuleParameters : ParameterBase
    {
        ...
        public EgeHayatHrmReplicationModuleParameters()
            : base()
        {
        ...
        {
            return new EgeHayatHrmReplicationModuleParameters();
        }
    }
}
